                        ...
                        <ol className="timeline-list">
                           <li className="timeline-item">
                              ...
                              <p className="timeline-text">
                                 Ordinary National Diploma – OND, Computer
                                 Science
                              </p>
                        ...
                        <ul className="skills-list content-card">
                           <div className="myTechnology">
                              ...
                              <li className="skills-item">
                                 ...
                                 <p className="timeline-text">Node.js</p>
                                 <p className="timeline-text">Mocha</p>
                                 <p className="timeline-text">Hardhat</p>
                                 <p className="timeline-text">Truffle</p>
                                 {/* <p className="timeline-text">Node.js</p> */}
                              </li>
                           </div>
                        </ul>
                        ...
                        <ul className="project-list">
                           ...
                           >
                              ...
                              >
                                 ...
                                 <h3 className="project-title">
                                    Venmo. Solidity, Next, React, Javascript,
                                    Truffle,
                                 </h3>
                                 <p className="project-category">
                           ...
                           >
                              <a href="#" target="_blank" rel="noreferrer">
                                 ...
                                 <p className="project-category">
                                    Lead_Tracker (extension) Where you can
                                    add/save your preffered url.
                                 </p>
                              </a>
                           </li>
                        </ul>
